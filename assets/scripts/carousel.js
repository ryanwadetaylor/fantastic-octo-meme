...
$(function() {
  ...
  var CLASSES = {
    ...
    ACTIVE_DOT_CLASS: "pagination_isActive"
  };
  ...
  Carousel.prototype.setupHandlers = function() {
    ...
    this.handlePrevClick = $.proxy(this.onPrevClick, this);
    this.handleNextClick = $.proxy(this.onNextClick, this);
  ...
  Carousel.prototype.createChildren = function() {
    ...
    // pagination
    this.$pages = $(SELECTORS.PAGE_ID);
    this.$dots = this.$pages.children();
    this.$currentPage = this.$dots.eq(this.currentIndex);
    ...
    this.$currentPage.addClass(CLASSES.ACTIVE_DOT_CLASS);
  ...
  Carousel.prototype.goToSlide = function(index) {
    ...
    // pagination
    this.$currentPage.removeClass(CLASSES.ACTIVE_DOT_CLASS);

    this.$currentSlide = this.$slides.eq(index);

    //pagination
    this.$currentPage = this.$dots.eq(index);
  ...
  /**
   * Go to previous slide on prev arrow click
   * @method onPrevClick
   * @public
   * @param {Object} event The event object
   */
  Carousel.prototype.onPrevClick = function(e) {
    this.goToPreviousSlide();
  };

  /**
   * Go to next slide on next arrow click
   * @method onNextClick
   * @public
   * @param {Object} event The event object
   */
  Carousel.prototype.onNextClick = function(e) {
    this.goToNextSlide();
  };
